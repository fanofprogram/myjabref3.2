...
import skyeagle.plugin.gui.GmailImporterPaneComponent;
...
public class JabRefFrame extends JFrame implements OutputPrinter {
    ...
    private GmailImporterPaneComponent gmc;
    ...
    private void initSidePane() {
        ...
        gmc = new GmailImporterPaneComponent(sidePaneManager, this);
    ...
    private void fillMenu() {
        ...
        JMenu plugins = JabRefFrame.subMenu(Localization.menuTitle("Plugins"));
        ...
        plugins.add(gmc.getAction());
        if (prefs.getBoolean(JabRefPreferences.PLUGIN_VISIBLE)) {
            sidePaneManager.register(gmc.getTitle(), gmc);
            sidePaneManager.show(gmc.getTitle());
        }
        mb.add(plugins);
